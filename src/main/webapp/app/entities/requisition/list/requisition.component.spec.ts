...
describe('Component Tests', () => {
  describe('Requisition Management Component', () => {
    let comp: RequisitionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(RequisitionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.requisitions?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

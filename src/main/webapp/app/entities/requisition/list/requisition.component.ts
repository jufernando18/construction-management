...
export class RequisitionComponent implements OnInit {
  ...
  trackId(index: number, item: IRequisition): number {
    return item.id!;
  }

  delete(requisition: IRequisition): void {
    const modalRef = this.modalService.open(RequisitionDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
  ...
  protected onSuccess(data: IRequisition[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {

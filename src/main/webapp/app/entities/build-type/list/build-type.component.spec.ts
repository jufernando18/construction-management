...
describe('Component Tests', () => {
  describe('BuildType Management Component', () => {
    let comp: BuildTypeComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [BuildTypeComponent],
        providers: [
          Router,
          {
        ...
        .overrideTemplate(BuildTypeComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.buildTypes?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

...
describe('Component Tests', () => {
  describe('Citadel Management Component', () => {
    let comp: CitadelComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CitadelComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.citadels?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

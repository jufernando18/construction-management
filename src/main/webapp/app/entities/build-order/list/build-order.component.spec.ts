...
describe('Component Tests', () => {
  describe('BuildOrder Management Component', () => {
    let comp: BuildOrderComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(BuildOrderComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.buildOrders?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
